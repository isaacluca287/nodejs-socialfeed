...
function configure(CONFIG) {
  ...
  loadPassportStrategy(FacebookStrategy, {
    clientID: _CONFIG.auth[NODE_ENV].facebook.consumerKey,
    clientSecret: _CONFIG.auth[NODE_ENV].facebook.consumerSecret,
    callbackURL: _CONFIG.auth[NODE_ENV].facebook.callbackUrl
  }, 'facebook')

  // loadPassportStrategy(GoogleStrategy, {...}, 'google')
  loadPassportStrategy(TwitterStrategy, {
    consumerKey: _CONFIG.auth[NODE_ENV].twitter.consumerKey,
    consumerSecret: _CONFIG.auth[NODE_ENV].twitter.consumerSecret,
    callbackURL: _CONFIG.auth[NODE_ENV].twitter.callbackUrl
  }, 'twitter')
